...
Just like in connect 4, I use 4-tuples in yavalath. This was easy because I already used those patterns to check for wins and loses. There are 102 4-in-rows in yavalath, thus 102x81=8262 inputs. With 16 hidden units thats 132k weights (66k chars) and this is the net uploaded to the arena.
